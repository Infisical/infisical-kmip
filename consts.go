...
// KMIP Profile Names
const (
	PROFILE_NAME_BASELINE_SERVER_BASIC_KMIP_V1_2                      Enum = 0x00000001
	PROFILE_NAME_BASELINE_SERVER_TLS_V1_2_KMIP_V1_2                   Enum = 0x00000002
	PROFILE_NAME_STORAGE_ARRAY_SELF_ENCRYPTING_DRIVE_SERVER_KMIP_V1_0 Enum = 0x00000040
	PROFILE_NAME_STORAGE_ARRAY_SELF_ENCRYPTING_DRIVE_SERVER_KMIP_V1_1 Enum = 0x00000041
	PROFILE_NAME_STORAGE_ARRAY_SELF_ENCRYPTING_DRIVE_SERVER_KMIP_V1_2 Enum = 0x00000042
	PROFILE_NAME_BASELINE_SERVER_BASIC_KMIP_V1_3                      Enum = 0x00000055
)

const (
	ENCODING_OPTION_NO_ENCODING Enum = 0x00000001
)
